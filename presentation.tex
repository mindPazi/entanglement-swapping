  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.46\textwidth}
      \begin{block}{Why Time Matters}
        ...
        \vskip 0.2em
        {\footnotesize \textbf{Assumption:} all BSMs fire at $T$, classical
        messages instantaneous. Swapping \emph{as soon as possible} would
        free repeater qubits earlier $\Rightarrow$ synchronous model is the
        pessimistic case.}
      \end{block}
    \end{column}
  \end{columns}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Werner Model for Fidelity}
        ...
        \]
        Exact for ideal BSMs $\Rightarrow$ closed-form prediction.
      \end{block}
    \end{column}
  \end{columns}
\end{frame}
